...
// I will find the end of loop: `render();` at line 265
const index = content.indexOf('render();');

// Get everything before `render();`
const beforeRender = content.substring(0, index + 'render();'.length);
...
fs.writeFileSync('src/components/ClashArenaBattle.tsx', beforeRender + correctEnding);
